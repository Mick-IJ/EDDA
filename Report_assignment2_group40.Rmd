...
par(mfrow=c(1,2))
interaction.plot(skill, interface, time, col = c('red', 'green', 'blue'), main = "Skill vs. interface", legend=F)
legend(3, 18, legend=c("int. 1", "int. 2", "int.3"),col=c("red","green", "black"), lty=1:2, cex=0.6)
interaction.plot(interface, skill, time, col = c('red', 'green', 'blue', 'yellow', 'black'), main = "Interface vs. skill")
legend(2,5, 20, legend=c("1", "2", "3", "4","5"),col=c("red","green","blue","yellow", "black"), lty=1:2, cex=0.6)
```
